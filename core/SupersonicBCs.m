...
%	Omega	= param(5);
	...
	Zbar	= param(8);
	w_p_a	= param(9);
	%	w_m_b	= param(10); Note these are switched just for  this case
	w_s_a 	= param(11);
	w_z_a	= param(12);
%	w_p_b	= param(13);
	w_m_a	= param(14); %note these are switched just for this case
%	w_s_b 	= param(15);
%	w_z_b	= param(16);
...
%	Pre-compute for convenience
	...
	Res(1) = (w_m_a_num - w_m_a);%	(u-c) = prescribed at the outlet
